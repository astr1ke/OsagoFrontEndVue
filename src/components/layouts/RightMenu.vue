<template>
    <div class="main page_wrapper page padding">

            <div class='sidebar_wrapper'>
                <div class='sidebar_services'>

                    <a href='https://dkbm-web.autoins.ru/dkbm-web-1.0/bsostate.htm'>
                        <svg version="1.1" id="Слой_1" x="0px" y="0px" viewBox="0 0 90 90"
                    ...
                    <router-link :to="{name: 'calc-osago'}">
	...
	c7.6-7.6,12.3-18.1,12.3-29.7S82.5,22.9,74.9,15.3z"/>
                    ...
                    <a href='https://dkbm-web.autoins.ru/dkbm-web-1.0/kbm.htm'>
